...
var miss2 = -1;
const textList2 = [
    { name: "君の名前はなんですか", romaji: ["kiminonamaehananndesuka"], count: 0 },
    { name: "本を読むことが大好きです", romaji: ["honnwoyomukotogadaisukidesu"], count: 0 },
    { name: "数学が大の苦手なんです", romaji: ["suugakugadainonigatenanndesu"], count: 0 },
    { name: "お母さんのお弁当は最高", romaji: ["okaasannnoobenntouhasaikou"], count: 0 },
    { name: "僕はプログラミングが趣味です", romaji: ["bokuhapuroguraminngugasyumidesu"], count: 0 },
    { name: "明日の給食は僕の大好きなハンバーグ", romaji: ["asitanokyuusyokuhabokunodaisukinahannba-gu"], count: 0 },
    { name: "休み時間は昼寝をする", romaji: ["yasumizikannhahirunewosuru"], count: 0 },
    { name: "あの人はわがままなんだから", romaji: ["anohitohawagamamananndakara"], count: 0 },
    { name: "無心で思い切り走りたい気分です", romaji: ["musinndeomoikirihasiritaikibunndesu"], count: 0 },
    { name: "荷物が多くて肩が痛い", romaji: ["nimotugaookutekatagaitai"], count: 0 },
    { name: "久しぶりに料理でもしてみようかな", romaji: ["hisasiburiniryouridemositemiyoukana"], count: 0 },
    { name: "周りがうるさくて集中できない", romaji: ["mawarigaurusakutesyuutyuudekinai"], count: 0 },
    { name: "ウーバーワールド最高だ", romaji: ["u-ba-wa-rudosaikouda"], count: 0 },
    { name: "レポートが終わってなくてピンチです", romaji: ["repo-togaowattenakutepinntidesu"], count: 0 },
    { name: "お父さんいつもお仕事お疲れ様", romaji: ["otoosannitumoosigotootukaresama"], count: 0 },
    { name: "あなたの将来の夢はなんですか", romaji: ["anatanosyourainoyumehananndesuka"], count: 0 },
    { name: "最近寒くなってきましたね", romaji: ["saikinnsamukunattekimasitane"], count: 0 },
    { name: "来週はバンドのライブに行く予定です", romaji: ["raisyuuhabanndonoraibuniikuyoteidesu"], count: 0 },
    { name: "マックのポテトが一番好き", romaji: ["makkunopotetogaitibannsuki"], count: 0 },
    { name: "旅行に行って気分転換", romaji: ["ryokouniittekibunntennkann"], count: 0 },
    { name: "プロジェクトが計画的に進められている", romaji: ["purozyekutogakeikakutekinisusumerareteiru"], count: 0 },
    { name: "大変申し訳ございませんでした", romaji: ["taihennmousiwakegozaimasenndesita"], count: 0 },
    { name: "アプリゲームを開発している", romaji: ["apurige-muwokaihatusiteiru"], count: 0 },
  ];